...
To formally define this notion of a limit, we would need to use the delta-epsilon definition of a limit, which is way out of scope of this course, so just use your intuition here (but remember to adequetly justify your steps!). If you're 
